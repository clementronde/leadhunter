    ...
    <div className="p-6 max-w-3xl space-y-6">
      ...
      {success && (
        <div className="flex items-center gap-3 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
          ...
          <div>
            <p className="font-semibold text-emerald-800">Bienvenue dans le plan Pro !</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className={`p-5 ${isPro ? 'opacity-60' : 'ring-2 ring-amber-400'}`}>
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <h3 className="text-xl font-bold text-zinc-900">Gratuit</h3>
            </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              {!canScan && (
                <p className="text-xs text-red-600 mt-1 font-medium">Limite mensuelle atteinte</p>
              )}
            </div>
        ...
        <Card className={`p-5 ${isPro ? 'ring-2 ring-amber-400' : ''}`}>
          ...
          <p className="text-sm text-zinc-500 mb-4">
            <span className="text-2xl font-bold text-zinc-900">29€</span>
      ...
      {!isPro && (
        <Card className="p-5">
          <h3 className="font-semibold text-zinc-900 mb-3">Questions fréquentes</h3>
          <div className="space-y-3 text-sm text-zinc-600">
            <div>
              <p className="font-medium text-zinc-800">Est-ce sans engagement ?</p>
              <p>Oui, vous pouvez annuler à tout moment depuis le portail de gestion.</p>
            </div>
            <div>
              <p className="font-medium text-zinc-800">Quand l'accès Pro est-il activé ?</p>
              <p>Immédiatement après le paiement — pas d'attente.</p>
            </div>
            <div>
              <p className="font-medium text-zinc-800">Quels moyens de paiement ?</p>
